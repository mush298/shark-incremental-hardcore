...
LANGUAGES.EN = {
    ...
    text: {
        ...
        'su-p1-desc': `Increases ${toTextStyle('Fish','fish')} eaten by <b>×10</b> per level.`,
        ...
        'research-idk-name': "Better Strength",
        'research-idk-desc': `Boost the effect of upgrade 'Shark Strength'.`,

        'research-idk2-name': "Better Things",
        'research-idk2-desc': `Reduce the cost of the first 2 ${toTextStyle("Prestige",'prestige')} upgrades.`,

        'research-idk3-name': "Softcap, begone!",
        'research-idk3-desc': `Remove the <b>secret</b> softcap I put at 1.000UDc of ${toTextStyle("Fish",'fish')} gain, hehe.`,

        'research-idk4-name': "Googol",
        'research-idk4-desc': `${formatPow(1.1)} ${toTextStyle("Fish",'fish')} gain.`,
        ...
        'progress-1-text': r => `Reach ${format(r)} ${toTextStyle('Prestige','prestige')} shards to unlock Automation and Research`,
        'progress-2-text': r => `Reach ${format(r)} ${toTextStyle('Prestige','prestige')} shards because why not?`,
        ...
        'scalings': {
            ...
            'su_p1' : `"Super Shark Strength" Upgrade`,
        },
