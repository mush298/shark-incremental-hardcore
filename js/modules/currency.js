const CURRENCIES = {
    fish: {
        ...
        get gain() {
            ...
            if (hasResearch('p3', 1)) x = x.mul(100)
            ...
            if (hasResearch('idk4')) x = x.pow(researchEffect('idk4'));

            if (player.shark_level.gte(107)) x = x.pow(1.05);
            ...
            if (!hasResearch('idk3')) x = x.overflow(1e36,0.75)
    ...
    prestige: {
        ...
        get gain() {
            ...
            var exp = 0.5
            if (hasResearch('p4')) exp += 0.125
            if (hasEvolutionGoal(5)) exp += 0.0125

            if (player.shark_level.gte(305)) exp += 0.05
            ...
            x = x.overflow(1e93, 0.75)

            if (player.shark_level.gte(312)) x = x.mul(1e20)
